...
public class BuilDataUserPut implements Question <UserModel>{

    @Override
    public UserModel answeredBy(Actor actor) {
        Map<String, String> data = Data.extractPut().get(0);
    ...
    public static BuilDataUserPut was(){
        return new BuilDataUserPut();
    }
}
